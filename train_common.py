...
def	log_train_psnr(result, imsource, loss, writer, epoch, idx, num_minibatches, training_params, t0):
	'''Logs trai loss.
	'''
...
# 		  training_params['step'])
	print("[epoch {}][{}/{}] loss: {:1.4f} PSNR_train: {:1.4f} t:{}".\
		  format(epoch+1, idx+1, num_minibatches, loss.item(), 0.0, time.time()-t0))
